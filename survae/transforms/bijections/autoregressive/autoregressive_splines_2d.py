...
class LinearSplineAutoregressiveBijection2d(AutoregressiveBijection2d):
    ...
    def __init__(self, autoregressive_net, num_bins, autoregressive_order='raster_cwh'):
        super(LinearSplineAutoregressiveBijection2d, self).__init__(autoregressive_net=autoregressive_net, autoregressive_order=autoregressive_order)
...
class QuadraticSplineAutoregressiveBijection2d(AutoregressiveBijection2d):
    ...
    def __init__(self, autoregressive_net, num_bins, autoregressive_order='raster_cwh'):
        super(QuadraticSplineAutoregressiveBijection2d, self).__init__(autoregressive_net=autoregressive_net, autoregressive_order=autoregressive_order)
        self.num_bins = num_bins
...
class CubicSplineAutoregressiveBijection2d(AutoregressiveBijection2d):
    ...
    def __init__(self, autoregressive_net, num_bins, autoregressive_order='raster_cwh'):
        super(CubicSplineAutoregressiveBijection2d, self).__init__(autoregressive_net=autoregressive_net, autoregressive_order=autoregressive_order)
        self.num_bins = num_bins
...
class RationalQuadraticSplineAutoregressiveBijection2d(AutoregressiveBijection2d):
    ...
    def __init__(self, autoregressive_net, num_bins, autoregressive_order='raster_cwh'):
        super(RationalQuadraticSplineAutoregressiveBijection2d, self).__init__(autoregressive_net=autoregressive_net, autoregressive_order=autoregressive_order)
        self.num_bins = num_bins
