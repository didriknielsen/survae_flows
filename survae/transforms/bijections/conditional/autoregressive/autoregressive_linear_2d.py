...
class ConditionalAdditiveAutoregressiveBijection2d(ConditionalAutoregressiveBijection2d):
...
class ConditionalAffineAutoregressiveBijection2d(ConditionalAutoregressiveBijection2d):
    ...
    def __init__(self, autoregressive_net, autoregressive_order='raster_cwh', scale_fn=lambda s: torch.exp(s)):
        super(ConditionalAffineAutoregressiveBijection2d, self).__init__(autoregressive_net=autoregressive_net, autoregressive_order=autoregressive_order)
